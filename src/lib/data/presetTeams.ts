...
export const PRESET_TEAMS: PresetTeam[] = [
  ...
  {
    slug: "growth-squad",
    label: "Marketing Growth Squad",
    description: "Turn positioning into measurable demand across content, search, social, and retention.",
    icon: TrendingUp,
    color: "#ec4899",
    agents: [
  ...
  },
  {
    ...
    label: "Paid Acquisition Squad",
    description: "Buy measurable demand with controlled budgets, reliable tracking, and independent audit.",
    icon: TrendingUp,
    color: "#a855f7",
    agents: [
